...
typedef struct
{	
	Sort_TypeDef InitC;//设置起始电流
	Sort_TypeDef StepC;//设置步进电流
	Sort_TypeDef ThresholdV;//设置门槛电压
	Sort_TypeDef StepT;//步进时间
	
	Sort_TypeDef PowV;//设置电源电压
	Sort_TypeDef PowC;//设置充电限制电流
	Sort_TypeDef PowCFC;//设置充电截止电流
	...
	Sort_TypeDef CutoffPV;//设置容量测试充电截止电压
	Sort_TypeDef CutoffPC;//设置容量测试充电截止电流
	Sort_TypeDef CTLoadC;//设置容量测试放电电流
